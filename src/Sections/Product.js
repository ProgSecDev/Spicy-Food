...
>
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-6 w-full">
              {selectedProducts.map((prod, i) => (
                <div key={i} className="flex flex-col items-center text-center gap-2 mt-4 p-1 border rounded shadow-sm bg-white/80 hover:scale-105 hover:z-10 transform transition duration-300 h-96 max-h-[350px] max-w-[350px]">
